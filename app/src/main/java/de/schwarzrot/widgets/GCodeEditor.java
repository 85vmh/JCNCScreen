...
public class GCodeEditor extends GCodeLister {
   public GCodeEditor(CncCommandWriter cmdWriter) {
   ...
   @Override
   protected void addComponents(JPanel p, CncCommandWriter cmdWriter) {
   ...
   protected JComponent createBottomAddon(CncCommandWriter cmdWriter) {
   ...
   protected JComponent createTopAddon(CncCommandWriter cmdWriter) {
      JPanel  pane       = new JPanel(new SpringLayout());
