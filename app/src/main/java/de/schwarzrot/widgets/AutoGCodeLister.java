...
public class AutoGCodeLister extends GCodeLister {
   ...
   public AutoGCodeLister(CncCommandWriter cmdWriter) {
   ...
   @Override
   protected JComponent createAddon(CncCommandWriter cmdWriter) {
   ...
   private String            rs274            = "/home/cnc/Work/linuxcnc-dev/bin/rs274";
