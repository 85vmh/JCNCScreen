...
public class JogTogglePane extends JPanel {
   public JogTogglePane(CncCommandWriter cmdWriter) {
      this.cmdWriter = cmdWriter;
      setLayout(new BoxLayout(this, BoxLayout.LINE_AXIS));
      add(createManualJogPane());
      add(createJogWheelPane());
   }


   protected JComponent createJogWheelPane() {
   ...
   protected JComponent createManualJogPane() {
      JPanel pane    = new JPanel();
