...
public class PaneStack extends JPanel implements HierarchyListener, PropertyChangeListener {
   ...
   private PaneStack(CncCommandWriter cmdWriter) {
   ...
   private void createUI(CncErrorReader errorReader) {
   ...
   public static PaneStack getInstance(CncCommandWriter cmdWriter, CncErrorReader errorReader) {
      if (instance == null) {
