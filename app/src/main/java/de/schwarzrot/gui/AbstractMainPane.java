...
import com.mindovercnc.base.data.InterpreterState;
import com.mindovercnc.base.data.TaskExecState;
...
public abstract class AbstractMainPane extends JDesktopPane
   ...
   class PowerHandler implements ActionListener {
      protected PowerHandler(LCStatus status, CncCommandWriter cmdWriter) {
         this.status    = status;
      ...
      private CncCommandWriter cmdWriter;
   }


   @SuppressWarnings("unchecked")
   protected AbstractMainPane(CncCommandWriter cmdWriter, CncErrorReader errorReader) {
   ...
   PaneStack                           paneStack;
   CncCommandWriter cmdWriter;
   CncErrorReader errorReader;
