...
public class CncErrorReader implements ActionListener {
   public CncErrorReader(List<SystemMessage> errorLog) {
      this.errorLog            = GlazedListsSwing.swingThreadProxyList((EventList<SystemMessage>) errorLog);
      this.confirmButtonActive = false;
      this.nativeErrorReader = new ErrorReader();
   }
   ...
   public boolean isBackendAvailable() {
      return nativeErrorReader.isBackendAvailable();
   }
   ...
   protected SystemMessage fetchMessage(){
      return nativeErrorReader.fetchMessage();
   }
   ...
   private ErrorReader nativeErrorReader;
}
