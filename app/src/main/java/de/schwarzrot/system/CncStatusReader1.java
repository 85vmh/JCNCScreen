...
public class CncStatusReader1 {
   ...
   public CncStatusReader1(CncErrorReader errorReader, IBufferDescriptor bufDesc) {
   ...
   protected void handleActiveCodes() {
      ...
      for (int i = 0; i < 16; ++i) {
         iv = statusBuffer.getInt(e.getOffset() + 4 * i);
      ...
      status.getSpeedInfo().setNominalFeed(statusBuffer.getDouble(e.getOffset() + 8));
      status.getSpeedInfo().setSpindleNominalSpeed(statusBuffer.getDouble(e.getOffset() + 16));
   }


   protected void handleGCodeFile() {
      e = bufDesc.get(BufferDescriptor.File);
      status.getGCodeInfo().setFileName(nativeStatusReader.getString(e.getOffset(), e.getSize()));

      e = bufDesc.get(BufferDescriptor.MotionLine);
      //      int line       = status.getGCodeInfo().getFrontendLine();
      int remoteLine = statusBuffer.getInt(e.getOffset());
   ...
   protected void handlePosition() {
      ...
      p.x    = statusBuffer.getDouble(e.getOffset());
      p.y    = statusBuffer.getDouble(e.getOffset() + 8);
      p.z    = statusBuffer.getDouble(e.getOffset() + 16);
      p.a    = statusBuffer.getDouble(e.getOffset() + 24);
      p.b    = statusBuffer.getDouble(e.getOffset() + 32);
      p.c    = statusBuffer.getDouble(e.getOffset() + 40);
      p.u    = statusBuffer.getDouble(e.getOffset() + 48);
      ...
      g5xO.y = statusBuffer.getDouble(e.getOffset() + 8);
      g5xO.z = statusBuffer.getDouble(e.getOffset() + 16);
      g5xO.a = statusBuffer.getDouble(e.getOffset() + 24);
      g5xO.b = statusBuffer.getDouble(e.getOffset() + 32);
      g5xO.c = statusBuffer.getDouble(e.getOffset() + 40);
      ...
      tO.y   = statusBuffer.getDouble(e.getOffset() + 8);
      tO.z   = statusBuffer.getDouble(e.getOffset() + 16);
      tO.a   = statusBuffer.getDouble(e.getOffset() + 24);
      tO.b   = statusBuffer.getDouble(e.getOffset() + 32);
      tO.c   = statusBuffer.getDouble(e.getOffset() + 40);
      ...
      g92O.y = statusBuffer.getDouble(e.getOffset() + 8);
      g92O.z = statusBuffer.getDouble(e.getOffset() + 16);
      g92O.a = statusBuffer.getDouble(e.getOffset() + 24);
      g92O.b = statusBuffer.getDouble(e.getOffset() + 32);
      g92O.c = statusBuffer.getDouble(e.getOffset() + 40);
      ...
      status.getDistanceToGo().setX(statusBuffer.getDouble(e.getOffset()));
      status.getDistanceToGo().setY(statusBuffer.getDouble(e.getOffset() + 8));
      status.getDistanceToGo().setZ(statusBuffer.getDouble(e.getOffset() + 16));
      status.getDistanceToGo().setA(statusBuffer.getDouble(e.getOffset() + 24));
      status.getDistanceToGo().setB(statusBuffer.getDouble(e.getOffset() + 32));
      status.getDistanceToGo().setC(statusBuffer.getDouble(e.getOffset() + 40));
      status.getDistanceToGo().setU(statusBuffer.getDouble(e.getOffset() + 48));
      status.getDistanceToGo().setV(statusBuffer.getDouble(e.getOffset() + 56));
      status.getDistanceToGo().setW(statusBuffer.getDouble(e.getOffset() + 64));

      //      // System.out.println("dtg: " + distanceToGo);
      //      e = bufDesc.get(BufferDescriptor.Distance2Go);
      //      status.getModel(LCStatus.MN_DTG).setValue(statusBuffer.getDouble(e.getOffset()));
   }
   ...
   protected void handleSignals() {
      ...
      for (String n : listOfSignals) {
         ...
         switch (e.getType()) {
            case Byte:
               m.setValue(statusBuffer.get(e.getOffset()) != 0);
               break;
            case Short:
               m.setValue(statusBuffer.getShort(e.getOffset()) != 0);
               break;
            case Integer:
               m.setValue(statusBuffer.getInt(e.getOffset()) != 0);
               break;
         }
      }
   }
   ...
   protected int handleSpindle() {
      ...
      si.setSpindleCurSpeed(statusBuffer.getDouble(e.getOffset() + activeSpindle * 168));

      e = bufDesc.get(BufferDescriptor.SpindleScale);
      si.setSpindleFactor(statusBuffer.getDouble(e.getOffset() + activeSpindle * 168) * 100.0);

      e = bufDesc.get(BufferDescriptor.SpindleDir);
      status.getModel(BufferDescriptor.SpindleDir)
            .setValue(statusBuffer.getInt(e.getOffset() + activeSpindle * 168));
   ...
   protected void handleStates() {
      ...
      status.setInterpState(statusBuffer.getInt(e.getOffset()));
   ...
   protected void handleToolChange() {
      ...
      iv = statusBuffer.getInt(e.getOffset());
      ...
      toolInfo.setNextToolNum(statusBuffer.getInt(e.getOffset()));

      e = bufDesc.get(BufferDescriptor.ToolOffsX);
      toolInfo.getOffset().setX(statusBuffer.getDouble(e.getOffset()));
      toolInfo.getOffset().setY(statusBuffer.getDouble(e.getOffset() + 8));
      toolInfo.getOffset().setZ(statusBuffer.getDouble(e.getOffset() + 16));
      toolInfo.getOffset().setA(statusBuffer.getDouble(e.getOffset() + 24));
      toolInfo.getOffset().setB(statusBuffer.getDouble(e.getOffset() + 32));
      toolInfo.getOffset().setC(statusBuffer.getDouble(e.getOffset() + 40));
      toolInfo.getOffset().setU(statusBuffer.getDouble(e.getOffset() + 48));
      toolInfo.getOffset().setV(statusBuffer.getDouble(e.getOffset() + 56));
      toolInfo.getOffset().setW(statusBuffer.getDouble(e.getOffset() + 64));
   }
   ...
   private CncErrorReader errorReader;
   ...
   private static final String[]   listOfSignals = { "joint_0_enabled", "joint_1_enabled", "joint_2_enabled",
         ...
         "lube", "estop", "debug" };
   static {
      l = Logger.getLogger(CncStatusReader1.class.getName());
   }
}
