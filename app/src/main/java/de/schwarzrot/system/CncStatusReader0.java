...
public class CncStatusReader0 {
    public CncStatusReader0(CncErrorReader errorReader, IBufferDescriptor bufDesc) {
    ...
    protected void handleGCodeFile() {
        ...
        status.getGCodeInfo().setFileName(getString(e.getOffset(), e.getSize()));
    ...
    */
    ...
    static {
        l = Logger.getLogger(CncStatusReader0.class.getName());
    }
}
